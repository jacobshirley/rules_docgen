...
some other ruleset that depends on rules_docs, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_docs=$(pwd)/rules_docs"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_docs` on your system will point to this folder.
...
https://github.com/jacobshirley/rules_docs/actions/workflows/tag.yaml
